...
def analyze(rows: list[dict[str, Any]], args: argparse.Namespace) -> dict[str, Any]:
    ...
    return {
        ...
        "dplr_compact_wy_stage_proto": [
            compact(r, ["_lineno", "status", "dtype", "device", "algorithm", "algorithm_family", "stage", "chunk_size", "compact_output_only", "compact_recompute_starts", "triton_compact_available", "triton_compact_summary_available", "triton_compact_prefix_available", "triton_compact_block_n", "triton_compact_block_r", "triton_compact_prefix_block_m", "triton_compact_start_state_dtype", "triton_apply_block_m", "B", "T", "H", "N", "warmup", "steps", "summary_shape", "summary_rank", "start_states_shape", "start_states_dtype", "chunk_end_shape", "state_source", "ms", "tokps", "recompute_prefix_probe_ms", "recompute_token_apply_probe_ms", "recompute_probe_sum_ms", "recompute_prefix_full_ratio", "recompute_token_apply_full_ratio", "recompute_probe_sum_full_ratio", "recompute_prefix_probe_shape", "recompute_prefix_probe_checksum_abs_max", "recompute_token_probe_out_shape", "transition_diag_max_abs_diff", "transition_left_max_abs_diff", "transition_right_max_abs_diff", "additive_left_max_abs_diff", "additive_right_max_abs_diff", "start_states_max_abs_diff", "prefix_vs_torch_summary_state_max_abs_diff", "chunk_end_max_abs_diff", "out_vs_apply_max_abs_diff", "out_max_abs_diff", "state_max_abs_diff", "out_min_cosine", "skip_reason", "error", "peak_vram_mb"])
